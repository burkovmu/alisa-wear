      ...
      <section className="relative h-[80vh]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-5xl font-light mb-4">Новая коллекция</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            ...
            <div className="flex space-x-4">
              ...
              <button className="text-gray-600 hover:text-black">Новая коллекция</button>
              <button className="text-red-500 hover:text-red-600">Sale</button>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="relative h-[400px] bg-gray-100 rounded-lg overflow-hidden">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <h2 className="text-4xl font-light mb-4">Новая коллекция</h2>
